...
class ReplicatedPool(BasePool):
    def __init__(self, service, name=None, pg_num=None, replicas=None,
                 percent_data=None, app_name=None, profile_name=None, op=None):
        ...
        :type replicas: int
        :raises: KeyError
        :param profile_name: Crush Profile to use (default: 'replicated_rule')
        ...
        if op:
            ...
            self.profile_name = op.get('crush-profile')
        else:
